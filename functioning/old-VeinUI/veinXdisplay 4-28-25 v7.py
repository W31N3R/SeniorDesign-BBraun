...
def update_video_frame():
    ...
    if ret:
        ...
        if bbox is not None and data:
            ...
            if qr_data.lower() == "20 gauge":
                control_var_1.set("20 Gauge")
                control_action_1("20 Gauge")  # Trigger the control action
            elif qr_data.lower() == "22 gauge":
                control_var_1.set("22 Gauge")
                control_action_1("22 Gauge")  # Trigger the control action
...
#4/28/25
# Jacob - changed all controls to new camera controlls
